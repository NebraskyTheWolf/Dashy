...
import eu.fluffici.dashy.ui.core.viewmodel.audit.AuditTableViewModel;
...
public class AuditTableAdapter extends AbstractTableAdapter<ColumnHeaderModel, RowHeaderModel, CellModel> {

    private final AuditTableViewModel myTableViewModel;

    public AuditTableAdapter(Context p_jContext) {
        super(p_jContext);

        this.myTableViewModel = new AuditTableViewModel();
    }
    ...
    public AbstractViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == UsersTableViewModel.GENDER_TYPE) {// Get gender cell xml Layout
     ...
     */
    public void setAuditsList(List<Audit> audits) {
        // Generate the lists that are used to TableViewAdapter
        myTableViewModel.generateListForTableView(audits);
