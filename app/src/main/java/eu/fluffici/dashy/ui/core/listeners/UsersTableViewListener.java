package eu.fluffici.dashy.ui.core.listeners;
...
import eu.fluffici.dashy.ui.core.popup.ColumnHeaderLongPressPopup;

public class UsersTableViewListener implements ITableViewListener {
    private static final String LOG_TAG = UsersTableViewListener.class.getSimpleName();

    private final ITableView mTableView;

    public UsersTableViewListener(ITableView pTableView) {
